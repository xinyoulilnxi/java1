...
//        om.registerModule(new IgnoreCollectionNullElementDeserializeModule());
    ...
    /**
     * @deprecated 这个方法已被废弃，代替方案是{@link JsonUtils#toJson(java.lang.Object)}
     */
    @Deprecated
    @Nullable
    ...
    /**
     * @deprecated 这个方法已被废弃，代替方案是{@link JsonUtils#toObject(java.lang.String, java.lang.Class)}
     */
    @Deprecated
    @Nullable
    ...
    /**
     * @deprecated 这个方法已被废弃，代替方案是{@link JsonUtils#toListOfObject(java.lang.String, java.lang.Class<T>)}
     */
    @Deprecated
    @Nullable
    ...
    /**
     * @deprecated 这个方法已被废弃，代替方案是{@link JsonUtils#toParameterizedObject(java.lang.String,
